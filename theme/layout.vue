...
a.top-16px.left-2.fixed.z-1000.cursor-pointer.mr-3.op-40.hover-op-100.transition(href="/" @click="close()")
  img.h-30px(src="https://raw.githubusercontent.com/nogac-org/nogac.org/main/content/public/media/logo/smooth.svg", alt="NOGAC logo")
  ...
  template(v-else-if="f.layout == 'home'")
    main.home.items-center.justify-center.overflow-clip(aria-labelledby="main-title")
      ...
      img.flex.justify-center(
        src="https://raw.githubusercontent.com/nogac-org/nogac.org/main/content/public/media/logo/shield.png" 
        alt="Description"
        style="flex: 1 1 1px")
      .flex-1.p-8.gap-1.flex.flex-col.origin-left(
        ...
        .text-2rem.md-ml-1 Planting a Modern Global Holistic Spiritual Nation
        .text-xl.md-ml-1 We foster global spiritual unity, create Kingdom Leaders, and build sustainable
        .text-xl.md-ml-1 communities united in faith and purpose, where everyone has the opportunity
        .text-xl.md-ml-1 to thrive via a global strategic mission for the Common Good of all.
        .text-sm.md-ml-1 &nbsp;
